...
function iniciarApp() {
    ...
    tabs(); //Cambiar las secciones donde se precione el tabs
    ...
    idCliente(); // Añáde el ide del cliente al onjeto de la Cita
...
function seleccionarServicio (servicio){
    ...
    // Comprobar si un servicio ya fue agregador en el arreglo
...
function mostrarResumen() {
    ...
    const botonReserva = document.createElement('BOTTUN');
...
async function reservarCita() {
    ...
    try {
        ...
        Swal.fire({
            icon: "error",
            title: "Error...",
            text: "Se produjo un error al guardar la Cita!",
        });
    }
