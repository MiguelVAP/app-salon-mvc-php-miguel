...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $mail = new PHPMailer();
        $mail->isSMTP();
        $mail->Host = $_ENV['EAMIL_HOST'];
        $mail->SMTPAuth =true;
        $mail->Port =$_ENV['EAMIL_PORT'];
        $mail->Username = $_ENV['EAMIL_USER'];
        $mail->Password = $_ENV['EAMIL_PASS'];
        ...
        solo debes confirmalo en el siguiente enlace</p>";
    ...
    public function enviarInstrucciones() {
        ...
        ve al siguiente enlace para restrablecerla </p>";
